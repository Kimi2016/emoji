...
public class UILabelCustom : UIWidget {
	public enum Effect {
		None,
		Shadow,
		Outline,
	...
	[Obsolete("Use UILabelCustom.bitmapFont instead")]
	...
	[System.Obsolete("Use 'overflowMethod == UILabelCustom.Overflow.ShrinkContent' instead")]
...
#if DYNAMIC_FONT
	static BetterList<UILabelCustom> mList = new BetterList<UILabelCustom>();
	...
	/// <summary>
	/// UILabelCustom needs additional processing when something changes.
	/// </summary>
...
#endif
 {
				...
				// Wrap the text
				bool fits = NGUITextCustom.WrapText(mText, out mProcessedText, true, false, true);
	...
	[System.Obsolete("Use UILabelCustom.GetCharacterAtPosition instead")]
	...
	public bool Wrap(string text, out string final, int height) {
		...
		bool retVal = NGUITextCustom.WrapText(text, out final);
		NGUIText.bitmapFont = null;
#if DYNAMIC_FONT
		NGUIText.dynamicFont = null;
#endif
