...
[CustomEditor(typeof(UILabelCustom), true)]
public class UILabelCustomInspector : UIWidgetInspector {
	public enum FontType {
		NGUI,
		Unity,
	}

	UILabelCustom mLabel;
	FontType mFontType;
	...
	protected override bool ShouldDrawProperties() {
		mLabel = mWidget as UILabelCustom;
		...
		EditorGUI.BeginDisabledGroup(!isValid);
		{
			...
			if (dynFont != null) {
				...
				if (!serializedObject.isEditingMultipleObjects) {
					if (mLabel.overflowMethod == UILabelCustom.Overflow.ShrinkContent)
