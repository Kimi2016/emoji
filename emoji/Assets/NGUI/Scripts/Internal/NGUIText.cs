...
static public class NGUIText
{
	...
	static public BetterList<Color> mColors = new BetterList<Color>();
	static public float mAlpha = 1f;
#if DYNAMIC_FONT
	...
	[DebuggerHidden]
	[DebuggerStepThrough]
	static public void ReplaceSpaceWithNewline (ref StringBuilder s)
	{
		int i = s.Length - 1;
		if (i > 0 && IsSpace(s[i])) s[i] = '\n';
	}
